  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={0}
        onKeyDown={onKeyDown}
        aria-label="Card stack — use arrow keys to navigate"
      >
        {/* Ambient glow under cards */}
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto rounded-full blur-3xl"
          style={{ height: 60, width: "55%", background: "rgba(0,0,0,0.35)" }}
          aria-hidden="true"
        />
  ...
  return (
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div
            ...
            style={{ background: "rgba(15,23,42,0.98)", color: "rgba(255,255,255,0.25)" }}
          >
            No image
          </div>
        )}
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        ...
        {item.description && (
          <div className="mt-1 line-clamp-2 text-sm" style={{ color: "rgba(255,255,255,0.7)" }}>
            {item.description}
          </div>
        )}
      </div>
